<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ManageProfile.aspx.cs" Inherits="WebApplication1.ManageProfile" %>
									...
									<div class="signup">
										...
										<div class="form-parent">
											...
											<div class="form-group" style="width: 50%!important;">
												<asp:TextBox runat="server" type="text" id="txtcon" class="form-control" placeholder="Country" required="true"/>
												<button class="btn icon"><i class="material-icons">my_location</i></button>
											</div>
											<div class="form-group" style="width: 50%!important;"> 
												<asp:TextBox runat="server" type="text" id="txtcity" class="form-control" placeholder="City" required="true"/>
												<button class="btn icon"><i class="material-icons">home_pin</i></button>
											</div>
										
										</div><br/>
										<asp:button runat="server" id="btnupdate" type="submit" class="btn button"  ValidationGroup="adminProfile"  onclick="btnupdate_Click" style ="background: linear-gradient(-135deg, #444929 0%, #765367 100%)" Text="Update Profile"/>
										<br /><a href="buyerprof.aspx" class="btn" style="color:black">Return Back</a>
										<div class="callout">
