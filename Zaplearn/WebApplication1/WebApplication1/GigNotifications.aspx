<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GigNotifications.aspx.cs" Inherits="WebApplication1.GigNotifications" %>
                        ...
                        <nav class="navbar navbar-expand-lg">
                            ...
                            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                                <ul id="nav" class="navbar-nav ml-auto">
                                    ...
                                    <li class="nav-item">
                                        <a class="page-scroll" href="app-decline.aspx?sessLoc=GigNotifications.aspx" style="text-decoration:none">Chat</a>
                                    </li>
                                    <li class="nav-item">
        ...
        <div class="container">
            <div class="row justify-content-center">
                ...
                <div class="section_title text-center pb-25 wow fadeInUp" data-wow-delay=".2s">
                        <h2 class="title" style="color:white">Gig Notifications</h2>
                        
                </div>
                </div>
            </div>
            <div id="divnot" runat="server" visible="false" >
                <center><style>
                            #divnot {
                    ...
                    <img src="images\nonotification3.gif" height="110px" width="auto" />
                    ...
                    <h5 style="color:lightgrey">No Notifications Here.</h5>
                </center>
        </div>
            <%--======== Body section ==========--%>
            <asp:Repeater runat="server" ID="repStatus"><ItemTemplate >
           <center>
            <div class="card text-center col-md-8 col-lg-8">
              <div class="card-header">
                Approve/ Decline orders    
              </div>
              <div class="card-body">
                <h4 class="card-title"><%# Eval("name") %></h4>
                <h5>Budget : <%# Eval("amount") %></h5><br>
                <a type="button" href="#" class="btn btn-outline-success appclick">Approve</a>
                <a type="button" href="#" class="btn btn-outline-danger decclick">Decline</a><br>
                <%--<a href="#" class="btn btn-primary">Chat</a>--%>
                 <a class="orderId" style="display:none"><%# Eval("OrderId") %></a> <br />
                 <a class="username" style="display:none"><%# Eval("username") %></a> <br />
                <a type="button" class="btn btn-primary mt-10" href='chat.aspx?sid=<%# Eval("username") %>'>Chat</a>
                 
              </div>
              <div class="card-footer text-muted">
                Deadline : <%# String.Format("{0:d}", Eval("deadLine"))%>
              </div>
            </div>
           </center><br>
           </ItemTemplate></asp:Repeater>
            
            <asp:Repeater runat="server" ID="Repprog"><ItemTemplate >
           <center>
            <div class="card text-center col-md-8 col-lg-8">
              <div class="card-header">
                Approve/ Decline orders    
              ...
              <div class="card-body">
                <h4 class="card-title"><%# Eval("name") %></h4>
                <h5>Budget : <%# Eval("amount") %></h5><br>
                <a type="button" href="#" class="btn btn-outline-success inprogclick">Started Work</a>
                <a type="button" href="#" class="btn btn-outline-danger decclick">Decline</a><br>
                <%--<a href="#" class="btn btn-primary">Chat</a>--%>
                 <a class="orderId" style="display:none"><%# Eval("OrderId") %></a> <br />
                 <a class="username" style="display:none"><%# Eval("username") %></a> <br />
            ...
            <asp:Repeater runat="server" ID="Repcomplete"><ItemTemplate >
           <center>
            <div class="card text-center col-md-8 col-lg-8">
              <div class="card-header">
                Approve/ Decline orders    
              ...
              <div class="card-body">
                <h4 class="card-title"><%# Eval("name") %></h4>
                <h5>Budget : <%# Eval("amount") %></h5><br>
                <a type="button" href="#" class="btn btn-outline-success completeclick">Completed</a>
                <a type="button" href="#" class="btn btn-outline-danger decclick">Decline</a><br>
                <%--<a href="#" class="btn btn-primary">Chat</a>--%>
                 <a class="username" style="display:none"><%# Eval("username") %></a> <br />
                 <a class="orderId" style="display:none"><%# Eval("OrderId") %></a> <br />
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12 p-0 wow fadeInUp" data-wow-delay=".8s">
                                            <div class="single_form text-center mt-20">
                                                <button class="btn btn3-inline-gradient main-btn-inline " style="border: 1.5px solid blue;">Submit Now</button>
                                            </div> <!-- single form -->
                                        </div>
                                    </div> <!-- row -->
                                </form>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $('.appclick').click(function () {
                ...
                var username1 = $(this).siblings('.username').text();
                var action = "approve";
                location.href = "app-decline.aspx?action=" + action + "&odid=" + id + "&usnm=" + username1;
            });

            $('.decclick').click(function () {
                var id = $(this).siblings('.orderId').text();
                var username1 = $(this).siblings('.username').text();
                var action = "decline";
                location.href = "app-decline.aspx?action=" + action + "&odid=" + id + "&usnm=" + username1;
