...
namespace WebApplication1
{
    public partial class ManageProfile : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (! IsPostBack )
            {
                cmd = new SqlCommand("select * from tblUser where username='" + Session["login"].ToString() + "'", conn);
                ...
                while (dr.Read())
                {
                    ...
                    txtcon.Text = dr["country"].ToString();
        ...
        protected void btnupdate_Click(object sender, EventArgs e)
        {
            ...
            cmd = new SqlCommand("Update tblUser SET password='" + txtpass.Text + "', name='" + txtname.Text + "', cno=" + txtcno.Text + ", email='" + txtemail.Text + "', profilepic='" + dbfullpath + "', DOB='" + txtDOB.Text + "', country='" + txtcon.Text + "', city='" + txtcity.Text + "' where username='" + Session["login"].ToString() + "'", conn);
