<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Gigs.aspx.cs" Inherits="WebApplication1.Gigs" %>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <nav class="navbar navbar-expand-lg">
                            <a class="navbar-brand logo" href="Landing.aspx">
                            ...
                            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                                <ul id="nav" class="navbar-nav ml-auto">
                                    <li class="nav-item active">
                                        <a class="page-scroll" href="gigs.aspx">Gigs</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="page-scroll" href="Landing.aspx#about"> About Us</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="page-scroll" href="Landing.aspx#services"> Services</a>
                                    </li>
                                    
                                    <li class="nav-item">
                                        <a class="page-scroll" href="Landing.aspx#testimonials">Testimonials</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="page-scroll" href="Landing.aspx#team">Team</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="page-scroll" href="Landing.aspx#contact">Contact</a>
                                    </li>
                                </ul>
                            </div> <!-- navbar collapse -->
                            <div class="button">
                            <a href="signup.aspx" class="btn-inline btn main-btn-inline">Get Started</a>
                            </div>
                ...
                <div class="col-lg-10 p-0">
                  <div class="row p-0">
                    ...
                    <asp:Repeater ID="Repeater1" runat="server">
                          <ItemTemplate >
                          <div class="col-lg-4 d-flex" onclick="window.location.href = 'login.aspx';">
